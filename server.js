...
function viewEmployeeByDepartment() {
  ...
  LEFT JOIN department d ON d.id = r.department_id GROUP BY d.id, d.name`
...
function promptDepartment(departmentChoices) {
  ...
  inquirer
    ...
    .then(function (answer) {
      ...
      var query =`SELECT e.id, e.first_name, e.last_name, r.title, d.name AS department FROM employee e
      JOIN role r ON e.role_id = r.id
      JOIN department d ON d.id = r.department_id WHERE d.id = ?`
...
// 3. View Employee by manager code will go here. Bonus option
...
function addRole() {
  ...
  var query =`SELECT d.id, d.name, r.salary AS budget FROM employee e
    JOIN role r ON e.role_id = r.id
    JOIN department d ON d.id = r.department_id 
